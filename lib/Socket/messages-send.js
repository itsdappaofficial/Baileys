...
export const makeMessagesSocket = (config) => {
    ...
    const { ev, authState, processingMutex, signalRepository, upsertMessage, query, fetchPrivacySettings, sendNode, messageMutex, groupMetadata, groupToggleEphemeral, delay } = sock;
